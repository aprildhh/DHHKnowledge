...
public class Constants {
    public static String[] types = {"RecyclerView","CustomControl","FAB", "MySQL","占位"};
    public static String[] leftTitles = {"RecyclerView","Android\n自定义控件", "Floating\nAction\nButton", "MySQL","占位"};
    public static String[] titles = {"Android《RecyclerView》","Android《自定义控件》","悬浮按钮（FloatingActionButton）","MySQL", "占位"};
